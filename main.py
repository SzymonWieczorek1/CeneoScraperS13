...
try:
    rcmd = opinion.select("span.user-post__author-recomendation > em").pop(0)
except IndexError:
    rcmd = None
...
print(author, rcmd, stars, content, pros, cons, purchased, publishDate, 
purchaseDate, useful, useless, sep="\n")
